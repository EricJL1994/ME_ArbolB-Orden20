...
public class ContenedorDeEnteros {
        ...
        protected class Nodo {
                ...
                int clave (int i) throws Exception {                                    //Devuelve la clave
                        if (i < 1 || i > numElei) throw new Exception("Error interno en el multirrama");
                        return clavei[i - 1];
                }
                ...
                int enlace (int i) throws Exception {                                   //Devuelve el enlace
                        if (i < 0 || i > numElei) throw new Exception ("Error interno en el multirrama");
                        return enlacei[i];
                }
                ...
                */
                ...
                /**
                * Inicializa el nodo partiendo de un byte[] previamente generado
                * con aByte
                */
                ...
                */
                ...
                /**
                * @param e -> Dato a buscar
                * @return Verdadero si el dato pasado está o falso si no está en el nodo
                 * @throws Exception
                */
        ...
        Nodo leer (int dir)throws Exception {
                ...
                if (n.dirección() != dir) throw new Exception ("Error al leer un nodo del arbol");
                return n;
        }
        ...
        */
        public void crear (String ruta, int tamañoDatos, int Orden) throws Exception {
                ...
                this.Orden = Orden;
                if (Orden < 5) throw new Exception ("Orden inferior a 5 en arbol B");
                Nodo nodo = new Nodo();
                nombreFichero = ruta;
        ...
        */                     
        public boolean insertar (int e) throws Exception {
                ...
                if (buscar(e, pila) == false) return false;     //No se admiten repetidos
                ...
                if (!pila.empty()) {                    //El arbol no está vacío
                        ...
                        while (!pila.empty()) {         //Arreglar sobrecarga
                                ...
                                if (pos == 0) partición_2_3 (padre, pos, nodoActual, der);
                                else partición_2_3 (padre, pos - 1, izq, nodoActual);
        ...
        /**
        * La función "extraer" extrae del contenedor el elemento pasado
        * por parámetro, devuelve verdadero si lo eliminó y falso en caso contrario.
        ...
        */
        public boolean extraer (int e) throws Exception {
                Stack pila = new Stack();
                if (!buscar(e, pila)) return false;             //Si no está, salimos sin hacer nada
                fichero.adjunto(1, --numElem);
                Nodo nodoActual = new Nodo();
                ...
                while (nodoActual.cardinal() < minimoClaves && nodoActual.dirección() != raiz){
                        ...
                        else recombinación_2_1(padre, pos, nodoActual, der);
                        nodoActual = padre;
                }
